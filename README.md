...
This repository contains the firmware source code for V2 tags. To configure and interact with tags using this firmware, install the tools given in [this repository](https://github.com/arribada/horizon-v2-tools).
